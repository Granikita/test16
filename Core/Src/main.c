...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(MOD_OUT_GPIO_Port, MOD_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : MOD_OUT_Pin */
  GPIO_InitStruct.Pin = MOD_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(MOD_OUT_GPIO_Port, &GPIO_InitStruct);
